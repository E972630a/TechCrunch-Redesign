        ...
        return (
            <div>
                ...
                <div className="advertise-container">
                    ...
                    <img className="advertise-image" src="img/BREXEVENT.png" />
                ...
                <div className="row">
                    <div className="column">
                        <div className="events-card">
                            <img src="eventstechcrunch.png" alt="Avatar" style="width:100%" />
                    ...
                    <div className="column">
                        <div className="events-card">
                            <img src="Early_Stage_Green_Background_466px.png" alt="Avatar" style="width:100%" />
                            <h2><b>TC Early Stage 2020</b></h2>
                            <p>Jul 21 - 22, 2020</p>
                            <button>Buy Tickets</button><br />
                            <button>Be a Sponsor</button>
                        </div>
                    </div>
                    <div className="column">
                        <div className="events-card">
                            <img src="Disrupt_Digital_2020_Key_Art_466px.jpg" alt="Avatar" style="width:100%" />
